                            ...
                            <div key={info["id"]} className="mb-4">
                                <div className="grid grid-cols-6 gap-0">
                                    ...
                                    <div className="col-span-4">
                                        <div className="bg-background-dark rounded-md p-4 shadow-lg">
                                        ...
                                        <div className="flex flex-wrap mt-2">
                                        {
                                            info["tech"] ? (
                                                info["tech"].map((label) => {
                                                    return (
                                                        <div key={info["id"]} className="mt-1 me-1 rounded-full bg-transparent py-1 px-3 border-2 border-solid border-primary">
                                                            <p className="text-text text-xs font-light">{label}</p>
                                                        </div>
                                                    )
                                                })
                                            ) : null
